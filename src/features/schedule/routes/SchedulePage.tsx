...
// PRD §7.10 — schedule page. Top: slot grid (calendar) + click → BookingDialog.
// Bottom: upcoming meetings DataTable. URL params drive both windowing
// (?from_date, ?days) so share-links work.
